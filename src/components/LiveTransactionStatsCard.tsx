...
import { PerformanceInfo } from "providers/stats/domiPerformanceInfo";
...
import {
  ...
  PingStatus,
  useSolanaPingInfo,
} from "providers/stats/DomiPingProvider";
...
export function LiveTransactionStatsCard() {
  ...
  return (
    <div className="card">
      ...
      {/*<PingStatsCardBody series={series} setSeries={setSeries} /> // TODO: deploy own API for this*/}
    </div>
  );
}
